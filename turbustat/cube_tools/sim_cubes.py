...
try:
    ...
    class SimCube(object):
        ...
        def __init__(self, cube, beam=None, mask=None, method="MAD",
                     compute=True):
        ...
        def compute_properties(self):
            '''
            Use SpectralCube to compute the moments. Also compute the
            integrated intensity based on the noise properties from Noise.
            '''
