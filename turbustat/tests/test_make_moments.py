...
class test_Mask_and_Moments(TestCase):
    ...
    def test_loading(self):
        ...
        npt.assert_allclose(test.moment0, dataset1["moment0_err"][0])
        npt.assert_allclose(test.moment1, dataset1["centroid_err"][0])
        npt.assert_allclose(test.linewidth_err, dataset1["linewidth_err"][0])
        npt.assert_allclose(test.intint_err,
                            dataset1["integratedintensity_err"][0])
