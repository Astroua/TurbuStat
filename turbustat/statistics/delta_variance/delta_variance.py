...
class DeltaVariance_Distance(object):
    ...
    def distance_metric(self, verbose=False):
        ...
        if nans1.any() or nans2.any():
            ...
            deltavar1 = np.log10(self.deltavar1.delta_var)[~all_nans]
            deltavar2 = np.log10(self.deltavar2.delta_var)[~all_nans]

        else:

            deltavar1 = np.log10(self.deltavar1.delta_var)
            deltavar2 = np.log10(self.deltavar2.delta_var)
