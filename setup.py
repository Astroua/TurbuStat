...
def check_dependencies():
  ...
  try:
      ...
      raise ImportError("Install or upgrade matplotlib before installing TurbuStat.")
  ...
  try:
      ...
      raise ImportError("Install or upgrade numpy before installing TurbuStat.")
  ...
  try:
      ...
      raise ImportError("Install or upgrade scipy before installing TurbuStat.")
  ...
  try:
      ...
      raise ImportError("Install or upgrade pandas before installing TurbuStat.")
  ...
  try:
      ...
      raise ImportError("Install or upgrade statsmodels before installing TurbuStat.")
  ...
  try:
      ...
      raise ImportError("Install or upgrade skimage before installing TurbuStat.")
  ...
  try:
      ...
      raise ImportError("Install or upgrade sklearn before installing TurbuStat.")

  try:
      from astropy.version import version as ast_version
      if parse_version(ast_version[:3]) < parse_version('0.4'):
          print("***Before installing, upgrade astropy to 0.4. NOTE: This is the dev version as of 17/06/14.***")
          raise ImportError
  except:
      raise ImportError("Install or upgrade astropy before installing TurbuStat.")

  try:
      import astrodendro
  except:
      raise ImportError(
        "Install or upgrade astrodendro before installing TurbuStat. ***NOTE: Need dev version as of 17/06/14.***")
